...
class Window(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        ttk.Label(self, text="Lancer l'extraction des données :", anchor="center").grid(row=0, column=0)
        ttk.Button(self, text='Go !', command=self.extract_data).grid(column=1, row=0) # On bind le bouton à la fonction extract_data
